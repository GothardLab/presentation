...
#		v0.6	02/25/16		Fixed trial counting bug, changed variable names, writes results to log file 
#		v0.7	03/01/16		Set up boolean config variables for task control, e.g. "catchPreTrialTouches"
...
int monitorXZeroPoint = -1024;	# The pixel touch value of the center of the monkey's monitor (important for calibrating!) (-1920)
...
begin
	...
	string monkeyResponseSub = "";
		...
		trialTextPretrial.set_caption( "Block: " + printf( currentBlock, "%2d" ) + "/" + printf( numberBlocks, "%2d" ) + 
										...
										"\n Correct: "+ printf( correctTouches, "%2d" ) + "/" + printf( trialCount, "%2d" ) +
										"\n Missed: "+ printf( missedTouches, "%2d" ) + "/" + printf( trialCount, "%2d" ) +
										"\n Early: "+ printf( earlyTouches, "%2d" ) + "/" + printf( trialCount, "%2d" ) +
...
begin
   ...
   touchBoxM.set_height(touchBoxSize);
	...
	trialTextTouchbox.set_caption( "Block: " + printf( currentBlock, "%2d" ) + "/" + printf( numberBlocks, "%2d" ) + 
										"\n Condition: "+ printf( currentCondition, "%2d" ) + "/" + printf( numberConditions, "%2d" ) +
										"\n Trial: "+ printf( trialCount, "%2d" ) + "/" + printf( numberTrials, "%2d" ) +
										"\n Correct: "+ printf( correctTouches, "%2d" ) + "/" + printf( trialCount, "%2d" ) +
										"\n Missed: "+ printf( missedTouches, "%2d" ) + "/" + printf( trialCount, "%2d" ) +
...
logFile.print( "Starting:\t"+taskName+"\n" );  
...
begin 
	...
	begin
		...
		logFile.print( "Cnd:\t"+string(currentCondition)+"\t" );  
		...
		term.print_line( "\n");
		term.print_line( "Correct touches: " + string( correctTouches ) + "/" + string(trialCount) + "   Missed touches: " + string( missedTouches ) + "/" + string(trialCount) + "   Ignored touches: " + string( ignoredTouches ) + "/" + string(trialCount) + "   Early touches: " + string( earlyTouches ) + "/" + string(trialCount));
		term.print_line( "\n");
...
term.print_line( "Correct touches: " + string( correctTouches ) + "/" + string(trialCount));
term.print_line( " Missed touches: " + string( missedTouches ) + "/" + string(trialCount) );
term.print_line( "  Early touches: " + string( earlyTouches ) + "/" + string(trialCount) );
