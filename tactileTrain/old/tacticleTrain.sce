...
picture{
	...
	bitmap {display_index=1;filename="placeholder.bmp";
		width=300;
		height=300;}leftImageMonkey;
		x=-300; y=0;	# Position of the image on screen
		
	bitmap {display_index=1;filename="placeholder.bmp";
		width=300;
		height=300;}rightImageMonkey;
		x=300; y=0;	# Position of the image on screen
...
picture{
	...
	bitmap {display_index=2;filename="placeholder.bmp";
		width=300;
		height=300;}leftImageExperimenter;
		x=-300; y=0;	# Position of the image on screen
		on_top=true;
	...
	bitmap {display_index=2;filename="placeholder.bmp";
		width=300;
		height=300;}rightImageExperimenter;
		x=300; y=0;	# Position of the image on screen
		on_top=true;
...
int touchBoxSize	=	300;			# size of touch box (pixels)
...
int leftStimulusXPosition = -450;# X position of the left stimulus
int rightStimulusXPosition = 450;# X position of the right stimulus
int stimulusYPosition = 0;			# Y position of both stimuli
