...
picture{
	...
	bitmap {display_index=1;filename="placeholder.bmp";
		width=400;
		height=400;}leftImageMonkey;
		x=-300; y=0;	# Position of the image on screen
		
	bitmap {display_index=1;filename="placeholder.bmp";
		width=400;
		height=400;}rightImageMonkey;
		x=300; y=0;	# Position of the image on screen
...
picture{
	...
	bitmap {display_index=2;filename="placeholder.bmp";
		width=400;
		height=400;}leftImageExperimenter;
		x=-300; y=0;	# Position of the image on screen
		on_top=true;
	...
	bitmap {display_index=2;filename="placeholder.bmp";
		width=400;
		height=400;}rightImageExperimenter;
		x=300; y=0;	# Position of the image on screen
		on_top=true;
...
int touchWindow	=	65; 			# this is the extra room that the monkey has around the edge of the touch box (pixels)
											# if touchWindow is 100, then there is a leniency of 100 pixels on all sides of the touch box
int startCueX		=	125;				# x-position of the touch box (pixels)(Default, can change by condition)
...
int correctItiDuration	=	2500; # Duration of the inter-trial-interval(ms)for correct trials
int startCueMissItiDuration		=	2500; # Duration of the inter-trial-interval(ms) for early touches
int missedItiDuration	=	2500; # Duration of the inter-trial-interval(ms) for missed trials
int ignoredItiDuration   =	2500;	# Duration of the inter-trial-interval(ms) for ignored trials
...
int leftStimulusXPosition = -300;# X position of the left stimulus
int rightStimulusXPosition = 625;# X position of the right stimulus
