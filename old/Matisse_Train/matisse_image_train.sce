...
int numberOfJuiceDrops=3;	# the duration of the TTL pulse that will trigger the juice pump
...
string exp_par="matisse_train_experimental_parameters.txt"; #the name of the parameter file that contains information about itm files, cnd files
