...
int fixwin=18; #this is the extra room that the monkey has around the edge of the fixspot (pixels)
...
int fixationDuration=150; # time required for the monkey to maintain fixation on the fixspot (ms)
int imageDuration=4000; # time required for the monkey to look at the image (ms)
