...
begin 
	...
	begin
		...
		term.print_line( "\n");
		term.print_line( "Trial: " + string( currentTrial ) + "/" + string(numberTrials) + "Cnd: " + string( currentCondition ) + "/" + string(ordered_cnds_to_show.count() ));
		term.print_line( "Correct touches: " + string( correctTouches ) + "/" + string(thisPresentation) + "   Missed touches: " + string( missedTouches ) + "/" + string(thisPresentation) + "   Ignored touches: " + string( ignoredTouches ) + "/" + string(thisPresentation) + "   Early touches: " + string( earlyTouches ) + "/" + string(thisPresentation));
		term.print_line( "\n");
