...
#~~~~~~~~~~~~~~~ end summary slide ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
# this is the picture that the experimenter see at the very end of the experiment
# a text summary of the monkey's behavior
picture {
	display_index=2; #display this picutre on the experimenter's monitor (monitor 2)
	...
	x=-240; y=250;
}endsummary; #the name of this picture is "endsummary"
...
int imagewidth=500; #the width that all images should be standardized to (pixels)
int imageheight=500; #the height that all images should be standardized to (pixels)
int itiDuration=2500; #duration of the inter-trial-interval (ms)
...
# update the text summary of the monkey's behavior and display it at the end of the experiment
trialInfo="DONE";
if totalFixspots==0.0 then;
	trialInfo.append("\nImage success:          \nFixspot success:          ");
elseif overall_cnd_shown==0.0 then;
...
text4.set_caption(trialInfo);
text4.redraw();
endsummary.present(); 
system_keyboard.set_time_out( 1000000  );# leave the summary on the display until the keyboard is pressed
