...
box { width=10; height=10; color=255,255,255; }fixspot;
...
trial {
	...
	terminator_button=1,2;
	max_responses=2;
	correct_feedback=distractor;
	incorrect_feedback=timeout;
	no_response_feedback=timeout;
	picture { bitmap { filename="26fgee02.bmp"; };
	x=0; y=0; };
	port_code=33;
}pic;
...
trial {
	...
	terminator_button=2;
	max_responses=2;
	correct_feedback=pic;
	incorrect_feedback=timeout;
	no_response_feedback=timeout;
	picture { box fixspot; x=0; y=0; };
	target_button=1;
	port_code=32;
}cue;
begin_pcl;
