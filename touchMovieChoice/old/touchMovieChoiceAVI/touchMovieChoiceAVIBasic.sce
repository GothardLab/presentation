...
begin
   ...
   string monkeyResponseSub = ""; 	# String to return with results of trial
	...
	# Set the position of the videos on the monkey's screen
	leftVideoMonkey.set_x(leftStimulusX);
	leftVideoMonkey.set_y(leftStimulusY);
	rightVideoMonkey.set_x(rightStimulusX);
	rightVideoMonkey.set_y(rightStimulusY);
	
	# Set the size of the videos of the monkey's screen
	leftVideoMonkey.set_width(stimulusWidth);
	leftVideoMonkey.set_height(stimulusHeight);
	rightVideoMonkey.set_width(stimulusWidth);
	rightVideoMonkey.set_height(stimulusHeight);
...
begin 
	...
	begin
		...
		leftVideoMonkey.set_filename(leftMovieName+".avi");
		leftVideoMonkey.set_logging(true);
		leftVideoMonkey.prepare();
		
		# Pre-load the right movie
		rightVideoMonkey.set_filename(rightMovieName+".avi");
		rightVideoMonkey.set_logging(true);
		rightVideoMonkey.prepare();
